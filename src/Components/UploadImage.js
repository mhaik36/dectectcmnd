...
class UploadImage extends Component {
    ...
    onFormSubmit(e) {
        ...
        axios.post("https://mhaik36server2.herokuapp.com/upload", formData, config)  //http://localhost:4000/upload
            .then((response) => {
                this.setState({
                    isUpload: true,
                    isPending: false,
                ...
                <div class="flex-container">
                    <div class="sub1">
                        ...
                        }
                        {
                            this.state.isUpload ?
                                <div>
                                    <img src={'https://mhaik36server2.herokuapp.com/uploads/'+this.state.imagePath} alt="Ảnh" height="250" width="250" />
                                </div>
                                :
                                null
                        }
